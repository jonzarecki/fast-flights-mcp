    ...
    def test_airport_search_real_api(self):
        ...
        for query, expected_indicators in test_cases:
            ...
            if result != "No airports found":
                ...
                found_indicator = any(indicator.lower() in result_lower for indicator in expected_indicators)
                assert found_indicator, f"No expected indicators found for '{query}' in result: {result}"
